...
6. [Guide](#6-guide)
    ...
    11. [Create Docker stack](#611-create-docker-stack)
    12. [Configure applications](#612-configure-applications)
    13. [Configure scheduled tasks](#613-configure-scheduled-tasks)
    14. [Configure public external traffic](#614-configure-public-external-traffic)
    15. [Configure private external traffic](#615-configure-private-external-traffic)
    16. [Install Cockpit](#616-install-cockpit)
...
#### 6.12.9. Configure Home Assistant
...
### 6.13. Configure scheduled tasks
...
### 6.14. Configure public external traffic
...
### 6.15. Configure private external traffic

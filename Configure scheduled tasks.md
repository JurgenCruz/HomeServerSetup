...
3. Copy the Docker apps image update script: `cp ./scripts/apps-update.sh /usr/local/sbin/`. This script loops the Dockhand list of stacks and updates the images and restarts the containers that have new images.

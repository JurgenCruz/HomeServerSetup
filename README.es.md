...
6. [Guía](#6-guía)
    ...
    11. [Crear stack de Docker](#611-crear-stack-de-docker)
    12. [Configurar aplicaciones](#612-configurar-aplicaciones)
    13. [Configurar tareas programadas](#613-configurar-tareas-programadas)
    14. [Configurar tráfico externo público](#614-configurar-tráfico-externo-público)
    15. [Configurar tráfico externo privado](#615-configurar-tráfico-externo-privado)
    16. [Instalar Cockpit](#616-instalar-cockpit)
...
#### 6.12.9. Configurar Home Assistant
...
### 6.13. Configurar tareas programadas
...
### 6.14. Configurar tráfico externo público
...
### 6.15. Configurar tráfico externo privado

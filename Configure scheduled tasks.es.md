...
3. Copiar el script para actualizar imágenes de Docker: `cp ./scripts/apps-update.sh /usr/local/sbin/`. Este script recorre la lista de stacks de Dockhand y actualiza las imágenes y reinicia los contenedores con nuevas imágenes.

...
[<img width="50%" src="buttons/prev-Guide.svg" alt="Guide">](Guide.md)[<img width="50%" src="buttons/next-Configure secure boot.svg" alt="Configure Secure Boot">](Configure%20secure%20boot.md)
